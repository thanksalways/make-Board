			...
			<div class="col-lg-12">
				<div class="card">
							...
							<tbody>
								...
								<c:forEach items="${articles}" var="article">
									<tr>
										...
										<td><a
											href="${path}/article/paging/read${pageMaker.makeQuery(pageMaker.criteria.page)}&article_no=${article.article_no}">${article.title}</a>
										</td>
										<%-- <td><a
					...
					<div class="card-footer">
						...
						<p>${path}/article/listPaging?page=${idx} </p>			
					</div>
				</div>
			</div>
			<!-- /.content -->
